            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
                {findSignupData.map((userData) => (
                    <div key={userData._id} className="p-4 border rounded shadow" style={{
                        ...
                        <h2 className="text-lg font-semibold mb-2 text-white hover:bg-gray-500 rounded-e-full">{userData.name}</h2>
                        <div className="flex items-center justify-between">
                            <p className="mt-2 text-white hover:bg-gray-500 rounded-e-full"> Email : {userData.email}</p>
                        </div>
                        <div className="max-w-full text-white hover:bg-gray-500 rounded-e-full">
                            <div className="flex items-center justify-between">
